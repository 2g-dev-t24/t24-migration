* @ValidationCode : MjozNzY4ODAxMTpDcDEyNTI6MTc0Mzg4MTQyMDU5MDpMdWlzIENhcHJhOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjI0X1NQMS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Apr 2025 16:30:20
...
*       Parametros para creacion de archivo
        Y.RUTA.ARCHIVO       = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.FileInPath>
        Y.NOMBRE.ARCHIVO     = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.FileInMask>
        ...
        Y.SEPARADOR.ARCHIVO  = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.FileInSep>
        Y.EXTENCION.ARCHIVO  = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.FileInExt>
...
*       -Parametros de Select
        Y.ID.TABLA.SELECT    = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.Aplicacion>
        YARR.CAMPOS.SELECT   = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.CampoCriterio>
        YARR.OPERADOR.SELECT = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.OperadorCriterio>
        YARR.VALORES.SELECT  = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.ValorCriterio>
...
*       Paramtros para Archivo de Salida
        YARR.POSICIONES.ARCH     = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.Posicion>
        YARR.ENCABEZADO.ARCH     = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.Encabezado>
        YARR.LONGITUD.ARCH       = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.Longitud>
        YARR.CAMPO.ARCH          = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.Campo>
        YARR.CONVERSION.ARCH     = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.Conversion>
        YARR.TIPO.LINEA.ARCHIVO  = R.ENQUIRY.LAYOUT<AbcTable.AbcComisionistasFileLayout.Encabezado>
*       -Se convierte en fm
...
*******        DISPLAY Y.ID.TABLA.SELECT
        ...
        Y.ARR.CAMPOS.SYS.STANDARD = R.APLICACION<EB.SystemTables.StandardSelection.SslSysFieldName>
        Y.ARR.POSICION.CAMPOS.SYS = R.APLICACION<EB.SystemTables.StandardSelection.SslSysFieldName>

        FIND "LOCAL.REF" IN Y.ARR.CAMPOS.SYS.STANDARD SETTING AP, VP, SP THEN
            Y.POSICION.LOCAL.REF = Y.ARR.POSICION.CAMPOS.SYS<1,VP>
        END
        Y.ARR.CAMPOS.LOC.STANDARD = R.APLICACION<EB.SystemTables.StandardSelection.SslUsrFieldName>
        Y.ARR.POSICION.CAMPOS.LOC = R.APLICACION<EB.SystemTables.StandardSelection.SslUsrFieldNo>
...
*   -SELECT que se ejecuta en base a los parametros Ingresado
        ...
        FOR I.CAMPOS = 1 TO Y.TOTAL.ARR
            ...
            END
        NEXT I.CAMPOS
        EB.DataAccess.Readlist(COMANDO.SELECT,Y.LIST.REGISTROS,'',YNO.REGISTROS,ERR.REG)
...
***        DISPLAY FN.TABLA.SELECT:"ID ... ":Y.ID.REG.PROCESA  ;*SBS-F&G
        IF Y.ID.REGISTRO.LAYOUT EQ "LIQUIDACION.INVS" OR Y.ID.REGISTRO.LAYOUT EQ "REPORTE.INVERSIONES" THEN   ;*SBS-F&G
            ...
            EB.DataAccess.Readlist(SEL.CMD.AAACT,YLIST.2,'',Y.NO.IDS,Y.SEL.ERROR)     ;*SBS-F&G
...
*           -Campos de STANDAR de tabla que se consulta en LINK
                ...
                YARR.CAMPOS.SYS.LINK     = R.APLICACION.LINK<EB.SystemTables.StandardSelection.SslSysFieldName>
                YARR.POS.CAMPOS.SYS.LINK = R.APLICACION.LINK<EB.SystemTables.StandardSelection.SslSysFieldNo>
...
*                 AL NO ENCONTRAR EL DATO EN LA TABLA VIVA SE PROCEDE A LEER LA HISTORICA
                ...
                END ELSE
                    FIND "LOCAL.REF" IN YARR.CAMPOS.SYS.LINK SETTING AP.LINK, VP.LINK, SP.LINK THEN
                        ...
                        YARR.CAMP.LOC.LINK   = R.APLICACION.LINK<EB.SystemTables.StandardSelection.SslUsrFieldName>
                        YARR.POS.LOC.LINK    = R.APLICACION.LINK<EB.SystemTables.StandardSelection.SslUsrFieldNo>
