...
*========================================================================
    ...
    Z = 0
    Z+= 1
    EB.SystemTables.setF(Z, "COUNTRY.ID")
    EB.SystemTables.setN(Z,"3.1")
    EB.SystemTables.setT(Z,"AAA")
    EB.SystemTables.setCheckfile(Z,"COUNTRY":FM:EB.COU.COUNTRY.NAME:FM:'A.')
    Z+= 1
    EB.SystemTables.setF(Z,"DOMINIO")
    EB.SystemTables.setN(Z,"4.3.C")
    EB.SystemTables.setT(Z,"A")
    EB.SystemTables.setV(Z + 9)
    EB.Template.setTableEquateprefix("AEDT")
