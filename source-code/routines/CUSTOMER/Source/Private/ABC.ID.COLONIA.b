* @ValidationCode : MjoxMTk2MDM5MjM1OkNwMTI1MjoxNzQ0ODE3MjkxNzE1Okx1aXMgQ2FwcmE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Apr 2025 12:28:11
...
***
    ...
    NOMBRE.COLONIA= EREPLACE(NOMBRE.COLONIA,'¥','Ñ')
...
**************
    ...
    IF Y.LIST.REG NE '' THEN
        FOR REC = 1 TO Y.NO.REGISTROS
            ...
            Y.COL.DESCRIP = R.COLONIAS<ABC.COLONIA>
...
RETURN
REMPLAZA.CARACTER:
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "Â¥","Ã‘"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "ª", "A"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "°", "O"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "ü", "U"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "Ü", "U"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "á", "A"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "é", "E"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "í", "I"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "ó", "O"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "ú", "U"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "Á", "A"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "É", "E"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "Í", "I"))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "Ó", "O"))
    ...
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "ñ", CHAR(165)))
    R.DATOS.REMPLAZAR = TRIM(EREPLACE(R.DATOS.REMPLAZAR, "Ñ", CHAR(165)))
