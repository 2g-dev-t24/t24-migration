...
*===============================================
    ...
    $USING EB.Interface
*-----------------------------------------------------------------------------
    EB.Template.setTableName('ABC.CANAL')      ;* Full application name including product prefix
    EB.Template.setTableTitle('CANAL')    ;* Screen title
    ...
    EB.Template.setTableEquateprefix('ABC.CNL')     ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------
