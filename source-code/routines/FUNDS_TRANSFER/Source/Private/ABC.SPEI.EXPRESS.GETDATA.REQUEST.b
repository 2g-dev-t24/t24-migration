* @ValidationCode : Mjo1ODQxOTU5NDA6Q3AxMjUyOjE3NDQ4MzU1OTgxMjA6RWRnYXI6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjRfU1AxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Apr 2025 15:33:18
...
*===============================================================================
* Nombre de Programa :  ABC.SPEI.EXPRESS.GETDATA.REQUEST
* Objetivo           :  Rutina que se encarga de mapear los datos para armado de XML en el proceso de SPEI Operaciones Express
...
*===============================================================================
* Modificaciones: Se agregan nuevos valores de Constantes
* Requerimiento      :  SPEI
* Desarrollador      :  esanchez - F&G Solutions
* Compania           :  ABC Capital Banco
* Fecha Creacion     :  08/Julio/2024
*===============================================================================
*-----------------------------------------------------------------------------
*COMPONENTIZACION
...
*-------------------------------------------------------------------------------
    ...
    Y.FECHA= sGetTODAY[1,4]:'-':sGetTODAY[5,2]:'-':sGetTODAY[7,2]
    Y.FECHA.INICIAL = sGetTODAY[1,4]:'-':sGetTODAY[5,2]:'-':sGetTODAY[7,2]
    ...
    Y.FECHA.LIMITE = ''
    Y.NUMSERIE.CER = ''
    Y.FECHA.CAPTURA = sGetTODAY[1,4]:'-':sGetTODAY[5,2]:'-':sGetTODAY[7,2]:'T':TIMEDATE()[1,8]
...
*-------------------------------------------------------------------------------
    ...
    ABC.BP.abcGetGeneralParam(Y.ID.PARAM, Y.LIST.PARAMS, Y.LIST.VALUES)
...
*    LOCATE 'CVE.ENTIDAD' IN Y.LIST.PARAMS SETTING Y.POS THEN
*        Y.CVEENTIDAD = Y.LIST.VALUES<Y.POS>
*    END
*    LOCATE 'ID.EMPRESA' IN Y.LIST.PARAMS SETTING Y.POS THEN
*        Y.ID.EMPRESA = Y.LIST.VALUES<Y.POS>
*    END
