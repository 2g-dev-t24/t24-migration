...
*========================================================================
    ...
    Z = 0
    Z+= 1;      EB.SystemTables.setF(Z,"OFS.SOURCE");      EB.SystemTables.setN(Z, "15.3.C");  EB.SystemTables.setZ(Z, "A")
    EB.SystemTables.setCheckfile(Z, "OFS.SOURCE":@FM:OFS.SRC.DESCRIPTION:@FM:'A.')
    Z+= 1;      EB.SystemTables.setF(Z,"NUM.MENSAJE");     EB.SystemTables.setN(Z, "4.1"); EB.SystemTables.setZ(Z, "")
    Z+= 1;      EB.SystemTables.setF(Z,"SMS.ACTIVO");      EB.SystemTables.setN(Z, "1.1"); EB.SystemTables.setZ(Z, "A") ; tmp= EB.SystemTables.getZ(); tmp<2>= @FM:"N_S" ; EB.SystemTables.setZ(Z, tmp)
    Z+= 1;      EB.SystemTables.setF(Z,"BANK.ID");         EB.SystemTables.setN(Z, "3..C"); EB.SystemTables.setZ(Z, "")
    Z+= 1;      EB.SystemTables.setF(Z,"BANK.CUST");       EB.SystemTables.setN(Z, "10..C");  EB.SystemTables.setZ(Z, "")
    EB.SystemTables.setCheckfile(Z,"CUSTOMER":@FM:EB.CUS.SHORT.NAME:@FM:'A.')
    Z+= 1;      EB.SystemTables.setF(Z,"BANK.NAME");       EB.SystemTables.setN(Z, "100..C");  EB.SystemTables.setZ(Z, "A")
    Z+= 1;      EB.SystemTables.setF(Z,"XX<TRAN.TYPE");    EB.SystemTables.setN(Z, "4.2");  EB.SystemTables.setZ(Z,"A"); tmp= EB.SystemTables.getZ(); tmp<2>= @FM:"AC_ATM_BIAT_BIAI_BIMT_BIMI_BIBT_BIBI_BIAC_BIMC_BIBC_BIAD_BIMD_BIBD_CUEM_CUMO_POS_SPEI_BACE_BMCE_BBCE"; EB.SystemTables.setZ(Z, tmp)
    Z+= 1;      EB.SystemTables.setF(Z,"XX-XX.TRANSACTION");  EB.SystemTables.setN(Z, "4..C");  EB.SystemTables.setZ(Z,"A")
    EB.SystemTables.setCheckfile(Z,"FT.TXN.TYPE.CONDITION":@FM:FT6.DESCRIPTION:@FM:'A.')
    Z+= 1;      EB.SystemTables.setF(Z,"XX>SUBJECT");      EB.SystemTables.setN(Z, "150.10");  EB.SystemTables.setZ(Z, "A")
    Z+= 1;      EB.SystemTables.setF(Z,"PHONE.1");         EB.SystemTables.setN(Z, "20.3");  EB.SystemTables.setZ(Z, "A")
    Z+= 1;      EB.SystemTables.setF(Z,"PHONE.2");         EB.SystemTables.setN(Z, "20..");  EB.SystemTables.setZ(Z, "A")
    Z+= 1;      EB.SystemTables.setF(Z,"XX<TRAN.TYPE.2");     EB.SystemTables.setN(Z, "4.2");  EB.SystemTables.setZ(Z,"A"); tmp= EB.SystemTables.getZ(); tmp<2>= @FM:"AC_ATM_BIAT_BIAI_BIMT_BIMI_BIBT_BIBI_BIAC_BIMC_BIBC_BIAD_BIMD_BIBD_CUEM_CUMO_POS_SPEI_BACE_BMCE_BBCE"; EB.SystemTables.setZ(Z, tmp)
    Z+= 1;      EB.SystemTables.setF(Z,"XX>ENV.CAMBIO.EST");  EB.SystemTables.setN(Z, "1.1");  EB.SystemTables.setZ(Z,"A"); tmp= EB.SystemTables.getZ(); tmp<2>= @FM:"N_S"; EB.SystemTables.setZ(Z, tmp)
    Z+ =1;      EB.SystemTables.setF(Z,"EMAIL.USUARIO");      EB.SystemTables.setN(Z, "80");  EB.SystemTables.setZ(Z,"A")
    Z+ =1;      EB.SystemTables.setF(Z,"EMAIL.OPERACION");    EB.SystemTables.setN(Z, "80.7");  EB.SystemTables.setZ(Z,"A")
    Z+ =1;      EB.SystemTables.setF(Z,"XX<EMAIL.ACC.MIN");         EB.SystemTables.setN(Z, "2.1.C");  EB.SystemTables.setZ(Z,"A"); tmp= EB.SystemTables.getZ(); tmp<8> = "NOEXPAND"; EB.SystemTables.setZ(Z, tmp)
    Z+ =1;      EB.SystemTables.setF(Z,"XX-EMAIL.DOM.MIN");         EB.SystemTables.setN(Z, "2.1.C");  EB.SystemTables.setZ(Z,"A")
    Z+ =1;      EB.SystemTables.setF(Z,"XX>EMAIL.MAX.DOT");         EB.SystemTables.setN(Z, "1.1.C");  EB.SystemTables.setZ(Z,"A")
    Z+ =1;      EB.SystemTables.setF(Z,"XX.VAL.GEN.DOM");           EB.SystemTables.setN(Z, "5.4");  EB.SystemTables.setZ(Z,"A")
    Z+ =1;      EB.SystemTables.setF(Z,"INVALID.CHAR");             EB.SystemTables.setN(Z, "60");   EB.SystemTables.setZ(Z,"ANY")
