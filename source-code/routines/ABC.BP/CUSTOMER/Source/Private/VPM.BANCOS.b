...
*   
    ...
    Z = 0
    Z += 1 ; EB.SystemTables.setF(Z,"BANCO")        ; EB.SystemTables.setN(Z,"40")   ; EB.SystemTables.setZ(Z,"A")
    Z += 1 ; EB.SystemTables.setF(Z,"TIPO")         ; EB.SystemTables.setN(Z,"3")    ; EB.SystemTables.setZ(Z,"A")
    Z += 1 ; EB.SystemTables.setF(Z,"XX.LOCAL.REF") ; EB.SystemTables.setN(Z,"35")   ; EB.SystemTables.setZ(Z,"A")
    Z += 1 ; EB.SystemTables.setF(Z,"XX.BINES")     ; EB.SystemTables.setN(Z,"6..C") ; EB.SystemTables.setZ(Z,"")
