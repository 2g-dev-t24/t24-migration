...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
    EB.Template.setTableName('ABC.MONTO.MENSUAL')       ;* Full application name including product prefix
    EB.Template.setTableTitle('ABC.MONTO.MENSUAL')   ;* Screen title
